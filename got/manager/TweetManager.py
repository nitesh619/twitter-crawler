...
class TweetManager:
    ...
    def getTweets(tweetCriteria, receiveBuffer=None, bufferLength=100):
        ...
        while active:
            time.sleep(1)  # robots.txt says, 1 sec crawl-delay should be.
            ...
            for tweetHTML in tweets:
                ...
                usernameTweet = tweetPQ("span.username.u-dir").text();
                fullNameTweet = tweetPQ("strong.fullname.show-popup-with-id").text();
    ...
    def getJsonReponse(tweetCriteria, refreshCursor, cookieJar):
        ...
        actual = str(time.strftime("%d %b %Y %H %M %S"))
        usr = "Tester_andreas.schleicher@experian.com" + actual[:11] + 'TIME' + actual[11:]
        headers = [
            ('Host', "twitter.com"),
            ('User-Agent', usr),  # used to be constant: "Mozilla/5.0 (Windows NT 6.1; Win64; x64)"
